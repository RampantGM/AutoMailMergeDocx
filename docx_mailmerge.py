...
if __name__ == '__main__':
    ...
    #docxmerge(args.f, args.d, args.o)
    docxmerge(args.f, json.loads(args.d), args.o)
    #docxmerge('ThisdocCopy.docx', {"MyFld": "Oh Hell Ya!","CAPLZD_FLD": "Bonus!!"}, 'out_file.docx')
    #docxmerge('Revised CA Law Dispute Letter 10282016 2.docx',{"Post_CO_Interest": "Respect it","Customer_Last_Name": "Respect it","D_Orig_Creditor_Address": "24 N. Main","Customer_City": "Respect it","Customer_State": "Respect it","Customer_Zip": "Respect it","Customer_Address": "Respect it","Chargeoff_Date": "Respect it","Account_Number": "Respect it","Customer_Middle_Name": "Respect it","D_Orig_Creditor_City": "Denver","Customer_First_Name": "Respect it","D_Orig_Creditor_State": "CO","D_Orig_Creditor_Zip": "80237","Post_CO_Fees": "Respect it",}, 'newfile.docx')
    print args.f + " merged."